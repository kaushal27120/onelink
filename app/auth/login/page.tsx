        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-[30px] font-black text-[#111827]">{pl ? 'Zaloguj się' : 'Log in'}</h2>
            ...
            <p className="text-[14px] text-[#9CA3AF]">
              ...
              <Link href="/auth/sign-up" className="text-blue-600 hover:text-blue-700 font-semibold transition-colors">
                {pl ? 'Zacznij 7-dniowy trial' : 'Start 7-day trial'}
              </Link>
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm p-5 mb-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px] text-[#9CA3AF]">{pl ? 'lub zaloguj się przez e-mail' : 'or log in with email'}</span>
              <div className="flex-1 h-px bg-[#F3F4F6]" />
            </div>
          </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-[12px] font-semibold text-[#374151]">{pl ? 'Hasło' : 'Password'}</label>
