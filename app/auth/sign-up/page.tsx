        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-7">
            <div className="flex items-center justify-between mb-4">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-[11px] font-bold text-emerald-700">
                ...
                {pl ? '7 dni za darmo · anuluj kiedy chcesz' : '7 days free · cancel any time'}
              </div>
              <LanguageSwitcher variant="light" />
            </div>
            <h2 className="text-[28px] font-black text-[#111827] mb-1">{pl ? 'Utwórz konto' : 'Create account'}</h2>
          ...
          <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm p-5 mb-4 space-y-3">
            ...
            >
              ...
              {pl ? 'Kontynuuj z Google' : 'Continue with Google'}
            </button>
            <button
              type="button"
              onClick={async () => {
            ...
            >
              ...
              {pl ? 'Kontynuuj z Apple' : 'Continue with Apple'}
            </button>
            <div className="flex items-center gap-3">
              <div className="flex-1 h-px bg-[#F3F4F6]" />
              <span className="text-[11px] text-[#9CA3AF]">{pl ? 'lub kontynuuj z e-mailem' : 'or continue with email'}</span>
              <div className="flex-1 h-px bg-[#F3F4F6]" />
            </div>
          </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div>
                <label className="block text-[12px] font-semibold text-[#374151] mb-1.5">
                  {pl ? 'Nazwa firmy / restauracji' : 'Company / restaurant name'}
                </label>
                <input
                  type="text"
                  required
                  ...
                  placeholder={pl ? 'np. Pizzeria da Marco' : 'e.g. Marco\'s Pizzeria'}
                  className={inp}
                />
              </div>
              ...
              >
                {loading ? (
                  ...
                  <><span>{pl ? 'Utwórz konto i zacznij trial' : 'Create account & start trial'}</span><ArrowRight className="w-4 h-4" /></>
                )}
              </button>
